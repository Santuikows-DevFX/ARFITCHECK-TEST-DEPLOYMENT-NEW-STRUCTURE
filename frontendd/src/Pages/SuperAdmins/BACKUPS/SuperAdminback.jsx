...
//           icon={<img src="../public/assets/analytics.png" alt="Analytics" style={{ width: '33px', height: '33px' }} />}
//           isSelected={selectedItem === 'Analytics And Reports'}
//           onClick={() => handleListItemClick('Analytics And Reports')}
//         />
//         <HoverableListItem
//           label="Team"
//           icon={<img src="../public/assets/tea.png" alt="Team" style={{ width: '30px', height: '30px' }} />}
...
//                 label="Inventory"
//                 icon={<img src="../public/assets/prdinv.png" alt="Inventory" style={{ width: '27px', height: '27px' }} />}
...
//               <SubHoverableListItem
//                 label="Size Table"
//                 icon={<img src="../public/assets/size.png" alt="Size Table" style={{ width: '27px', height: '27px' }} />}
...
//                   startIcon={<MailIcon />}
//                   onClick={handleMarkAllAsRead}
//                   sx={{ fontSize: '0.65rem', color: 'gray', fontFamily: 'Kanit' }}
...
//         {drawerContent}
//       </Drawer>
//       <Box sx={{ display: 'flex', height: '115vh' }} >
//         {!isMobile && (
...
//           flex="1" 
//           sx={{ 
//             backgroundImage: 'url(/public/assets/shopGraffiti1.png)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat',
