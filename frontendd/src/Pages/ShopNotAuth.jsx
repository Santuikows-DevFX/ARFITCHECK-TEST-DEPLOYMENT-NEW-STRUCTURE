...
import ProductDescriptionViewOnly from './Customers/ProductDescriptionViewOnly';
...
function ShopNotAuth() {
    ...
    const fetchProductsByChosenCateg = async () => {
        try {
            ...
            isLoading(true);
            const productResponse = await axiosClient.get(`prd/fetchProductByCateg/user/${category}`);
